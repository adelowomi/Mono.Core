...
namespace Mono.Core.LookUp.Tests
{
    public class LookUpServiceTests
    {
        ...
        public LookUpServiceTests()
        {
            ...
            mockBuilder.Setup(x => x.Build(It.IsAny<string>())).Returns(_mockLookUpService.Object);
            mockBuilder.Setup(x => x.BuildV3(It.IsAny<string>())).Returns(_mockLookUpServiceV3.Object);
